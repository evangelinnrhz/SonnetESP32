// ---- Configuration ----
// Set this to your ESP32's IP address (shown in the Serial Monitor after it
// connects to WiFi), or type it into the "Connection settings" box below.
let ESP32_IP = "192.168.1.50";
